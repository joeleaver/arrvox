...
use rkp_render::{
    rkp_renderer::RkpRenderer, rkp_scene_manager::RkpSceneManager, ViewportRenderer,
};
...
pub(super) struct RenderState {
    ...
    pub(super) renderer: RkpRenderer,
    ...
    pub(super) tlas_pass: rkp_render::tlas_pass::TlasPass,
    ...
    /// trace already binds).
    pub(super) tlas_build_pass: rkp_render::tlas_build_pass::TlasBuildPass,
