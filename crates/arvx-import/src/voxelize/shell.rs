...
use arvx_core::companion::{BoneVoxel, ColorVoxel};
use arvx_core::voxel::VoxelSample;
use arvx_core::{SparseOctree, brick_pool, sparse_octree};

use super::classify::{BrickResult, BrickWork};

/// Output of [`emit_shell_leaves`] — everything the `.arvx` writer needs.
