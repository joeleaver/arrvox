...
fn voxelize_octree_gpu_runs_end_to_end() {
    use arvx_core::brick_pool::BrickPool;
...
fn artifact_roundtrip_matches_direct_voxelize() {
    use arvx_core::voxelize_to_artifact;
    ...
    let mut scene_a = ArvxSceneManager::new(1_000_000);
    let r_a = scene_a
    ...
    let mut scene_b = ArvxSceneManager::new(1_000_000);
    let r_b = scene_b
