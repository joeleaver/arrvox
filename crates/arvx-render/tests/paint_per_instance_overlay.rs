...
//!
//! Bug fixed: load bunny.arvx twice, paint one of the instances, both
...
use arvx_core::LeafAttrOverlay;
use arvx_render::paint::PaintStamp;
use arvx_render::arvx_scene_manager::{AssetInfo, ArvxSceneManager};

fn build_scene_with_sphere() -> (ArvxSceneManager, AssetInfo) {
    let mut sm = ArvxSceneManager::new(256_000);
