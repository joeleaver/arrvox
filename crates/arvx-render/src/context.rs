...
impl RenderContext {
    ...
    pub fn new(instance: &wgpu::Instance, surface: &wgpu::Surface<'_>) -> Self {
        ...
        eprintln!(
            "[arvx_context] adapter={:?} granted limits: max_storage_buffer_binding_size={} max_buffer_size={}",
            adapter_info.name,
    ...
    pub fn new_headless() -> Self {
        let instance = wgpu::Instance::new(wgpu::InstanceDescriptor {
            ...
            // the ~0.7ms of `ARVX_MESH_DEBUG_DIRECT=1`. Bisected
        ...
        let (device, queue) = pollster::block_on(adapter.request_device(
            &wgpu::DeviceDescriptor {
                label: Some("arvx-render headless device"),
                required_features: wgpu::Features::FLOAT32_FILTERABLE
        ...
        eprintln!(
            "[arvx_context] granted features: multi_draw_indirect_count={} timestamp={} timestamp_inside={} float32_filterable={}",
