...
impl ArvxAtmospherePass {
    pub fn new(device: &wgpu::Device) -> Self {
        ...
        let trans_module = compile_pass_shader(
            device,
            wesl::include_wesl!("arvx_transmittance_lut"),
            "arvx_transmittance_lut",
        );
        ...
        let ms_module = compile_pass_shader(
            device,
            wesl::include_wesl!("arvx_multiscatter_lut"),
            "arvx_multiscatter_lut",
        );
        ...
        let sv_module = compile_pass_shader(
            device,
            wesl::include_wesl!("arvx_sky_view_lut"),
            "arvx_sky_view_lut",
        );
        ...
        let ap_module = compile_pass_shader(
            device,
            wesl::include_wesl!("arvx_aerial_perspective_lut"),
            "arvx_aerial_perspective_lut",
        );
