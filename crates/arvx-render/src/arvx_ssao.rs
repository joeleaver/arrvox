//! Arrvox screen-space ambient occlusion (SSAO) compute pass.
//!
...
impl ArvxSsaoPass {
    pub fn new(device: &wgpu::Device, queue: &wgpu::Queue, width: u32, height: u32) -> Self {
        ...
        let gbuffer_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("arvx_ssao gbuf layout"),
                entries: &[
                    bgl_texture(0),
                    bgl_texture(1),
                ],
        ...
        let output_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("arvx_ssao output layout"),
        ...
        let params_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("arvx_ssao params layout"),
                entries: &[
        ...
        let params_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("arvx_ssao params bg"),
        ...
        // Pipeline.
        let shader = crate::compile_pass_shader(device, wesl::include_wesl!("arvx_ssao"), "arvx_ssao");

        let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("arvx_ssao pipeline"),
            bind_group_layouts: &[
    ...
    fn create_output_bind_group(
        ...
        device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("arvx_ssao output bg"),
            layout,
