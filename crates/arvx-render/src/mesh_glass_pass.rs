...
//! the opaque visibility buffer) and the existing `arvx_glass`
...
//!    `gbuf_glass` contract `arvx_glass.wesl` consumes.
//!
...
impl MeshGlassPass {
    pub fn new(
        ...
        // instances (ArvxInstance array), instance_overlay, color_pool
        ...
        let vertex_layout = wgpu::VertexBufferLayout {
            array_stride: std::mem::size_of::<arvx_core::mesh_extract::MeshVertex>() as u64,
