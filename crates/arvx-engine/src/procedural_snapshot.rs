...
fn sphere_params(p: &arvx_procedural::node_kind::SphereParams) -> Vec<ProceduralParam> {
    vec![
...
fn box_params(p: &arvx_procedural::node_kind::BoxParams) -> Vec<ProceduralParam> {
    vec![
...
fn capsule_params(p: &arvx_procedural::node_kind::CapsuleParams) -> Vec<ProceduralParam> {
    vec![
        ProceduralParam { name: "material".into(), value: ProceduralParamValue::Material(p.material_id), range: None },
    ]
}

fn cylinder_params(p: &arvx_procedural::node_kind::CylinderParams) -> Vec<ProceduralParam> {
    vec![
        ProceduralParam { name: "material".into(), value: ProceduralParamValue::Material(p.material_id), range: None },
    ]
}

fn torus_params(p: &arvx_procedural::node_kind::TorusParams) -> Vec<ProceduralParam> {
    vec![
...
fn plane_params(p: &arvx_procedural::node_kind::PlaneParams) -> Vec<ProceduralParam> {
    vec![
        ProceduralParam { name: "material".into(), value: ProceduralParamValue::Material(p.material_id), range: None },
    ]
}

fn ramp_params(p: &arvx_procedural::node_kind::RampParams) -> Vec<ProceduralParam> {
    vec![
        ProceduralParam { name: "material".into(), value: ProceduralParamValue::Material(p.material_id), range: None },
        ProceduralParam { name: "color".into(), value: ProceduralParamValue::Color(rgba_from_color(p.color)), range: None },
    ]
...
fn noise_displace_params(
    p: &arvx_procedural::node_kind::NoiseDisplaceParams,
) -> Vec<ProceduralParam> {
    vec![
...
fn material_by_height_params(
    p: &arvx_procedural::node_kind::MaterialByHeightParams,
) -> Vec<ProceduralParam> {
    vec![
        ProceduralParam {
...
fn color_by_height_params(
    p: &arvx_procedural::node_kind::ColorByHeightParams,
) -> Vec<ProceduralParam> {
    vec![
        ProceduralParam {
            name: "low_color".into(),
...
fn material_by_noise_params(
    p: &arvx_procedural::node_kind::MaterialByNoiseParams,
) -> Vec<ProceduralParam> {
    vec![
...
fn color_by_noise_params(
    p: &arvx_procedural::node_kind::ColorByNoiseParams,
) -> Vec<ProceduralParam> {
    vec![
...
fn mirror_params(
    p: &arvx_procedural::node_kind::MirrorParams,
) -> Vec<ProceduralParam> {
...
fn array_params(
    p: &arvx_procedural::node_kind::ArrayParams,
) -> Vec<ProceduralParam> {
...
fn combinator_params(mc: &arvx_procedural::MaterialCombine) -> Vec<ProceduralParam> {
    let value = match mc {
        arvx_procedural::MaterialCombine::Winner => "Winner",
        arvx_procedural::MaterialCombine::Layered => "Layered",
        arvx_procedural::MaterialCombine::Blend { .. } => "Blend",
    };
    vec![ProceduralParam {
