...
//!
//! Pure math — depends only on glam and arvx_runtime::input.

use glam::Vec3;
use arvx_runtime::input::InputSystem;
...
pub fn default_action_map() -> arvx_runtime::input::ActionMap {
    use arvx_runtime::input::*;
