...
/// File change event types relevant to Arrvox.
#[derive(Debug, Clone)]
pub enum FileEvent {
    /// A .arvx model file was created or modified.
    ModelChanged(PathBuf),
    /// A .wgsl shader file was created or modified.
    ShaderChanged(PathBuf),
    /// A .arvxmat material file was created or modified.
...
pub struct ArvxFileWatcher {
    rx: mpsc::Receiver<FileEvent>,
    _watcher: RecommendedWatcher,
}

impl ArvxFileWatcher {
        ...
        let mut watcher = notify::recommended_watcher(move |res: Result<notify::Event, notify::Error>| {
            ...
            for path in &event.paths {
                ...
                let file_event = match ext {
                    "arvx" => Some(FileEvent::ModelChanged(path.clone())),
                    "wgsl" => Some(FileEvent::ShaderChanged(path.clone())),
                    "arvxmat" => Some(FileEvent::MaterialChanged(path.clone())),
