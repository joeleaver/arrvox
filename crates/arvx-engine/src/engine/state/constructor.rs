...
impl EngineState {
    pub(crate) fn new(
        ...
        let scene_mgr = std::sync::Arc::new(std::sync::Mutex::new(
            ArvxSceneManager::new(1_000_000),
        ));
        ...
        let mut input_system = arvx_runtime::input::InputSystem::new();
        ...
        Self {
            bake_worker,
            generator_system,
            user_shader_registry: arvx_render::shader_composer::UserShaderRegistry::empty(),
            ...
            painted_dirty_regions: std::collections::HashMap::new(),
            ...
            asset_load_worker: super::super::asset_load_worker::AssetLoadWorker::spawn(),
            loading_paths: std::collections::HashMap::new(),
            ...
            mesh_draws: std::sync::Arc::new(Vec::new()),
            ...
            pending_asset_loads: std::collections::VecDeque::new(),
            ...
            num_lights_cache: 1,
            shade_params_base: arvx_render::arvx_shade::ShadeParams::default(),
            lod_enabled: true,
